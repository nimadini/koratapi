...
public class DLLS28 {
	...
	return circular()&&size()&&link()&&sorted() &&size==11&&header!=null&&header.next!=null&&header.previous!=null&&header.element==0&&header.next.next!=null&&header.next.previous!=null&&header.next.element==1&&header.previous.next!=null&&header.previous.previous!=null&&header.previous.element==7&&header.next.next.next!=null&&header.next.next.previous!=null&&header.next.next.element==1&&header.previous.previous.next!=null&&header.previous.previous.previous!=null&&header.previous.previous.element==1&&header.next.next.next.next!=null;
	}
	public static IFinitization finDLLS28(int _x_) {
		IFinitization f = FinitizationFactory.create(DLLS28.class);
