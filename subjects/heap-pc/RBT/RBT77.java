...
public class RBT77 {
	...
	return acyclic()&&repOkColors()&&parentOK()&&searchOk()&&root!=null&&size==10&&root.right!=null&&root.elem==6&&root.left!=null&&root.color==0&&root.parent==null&&root.right.right!=null&&root.right.elem==8&&root.right.left!=null&&root.right.color==0&&root.right.parent!=null&&root.left.right!=null&&root.left.elem==2&&root.left.left!=null&&root.left.color==1&&root.left.parent!=null&&root.right.right.right==null&&root.right.right.elem==9&&root.right.right.left==null&&root.right.right.color==1&&root.right.right.parent!=null&&root.right.left.right==null&&root.right.left.elem==7&&root.right.left.left==null&&root.right.left.color==1;
	}
	public static IFinitization finRBT77(int _x_) {
		IFinitization f = FinitizationFactory.create(RBT77.class);
