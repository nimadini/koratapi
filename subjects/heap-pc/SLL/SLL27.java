...
public class SLL27 {
	...
	return structureOK()&&size() &&sorted() &&unique() &&header!=null&&size==10&&header.next!=null&&header.element==0&&header.next.next!=null&&header.next.element==0&&header.next.next.next!=null&&header.next.next.element==1&&header.next.next.next.next!=null&&header.next.next.next.element==4&&header.next.next.next.next.next!=null&&header.next.next.next.next.element==7;
	}
	public static IFinitization finSLL27(int _x_) {
		IFinitization f = FinitizationFactory.create(SLL27.class);
