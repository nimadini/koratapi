...
public class SLL68 {
	...
	return structureOK()&&size() &&sorted() &&unique() &&header!=null&&size==10&&header.next!=null&&header.element==0&&header.next.next!=null&&header.next.element==0&&header.next.next.next!=null&&header.next.next.element==3&&header.next.next.next.next!=null&&header.next.next.next.element==6&&header.next.next.next.next.next!=null&&header.next.next.next.next.element==8;
	}
	public static IFinitization finSLL68(int _x_) {
		IFinitization f = FinitizationFactory.create(SLL68.class);
