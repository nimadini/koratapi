...
public class SLL14 {
	...
	return structureOK()&&size() &&sorted() &&unique() &&header!=null&&size==10&&header.next!=null&&header.element==0&&header.next.next!=null&&header.next.element==0&&header.next.next.next!=null&&header.next.next.element==1&&header.next.next.next.next!=null&&header.next.next.next.element==2&&header.next.next.next.next.next!=null&&header.next.next.next.next.element==8;
	}
	public static IFinitization finSLL14(int _x_) {
		IFinitization f = FinitizationFactory.create(SLL14.class);
