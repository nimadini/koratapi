...
public class SLL15 {
	...
	return structureOK()&&size() &&sorted() &&unique() &&header!=null&&size==10&&header.next!=null&&header.element==0&&header.next.next!=null&&header.next.element==3&&header.next.next.next!=null&&header.next.next.element==4&&header.next.next.next.next!=null&&header.next.next.next.element==5&&header.next.next.next.next.next!=null&&header.next.next.next.next.element==6;
	}
	public static IFinitization finSLL15(int _x_) {
		IFinitization f = FinitizationFactory.create(SLL15.class);
