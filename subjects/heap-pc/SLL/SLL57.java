...
public class SLL57 {
	...
	return structureOK()&&size() &&sorted() &&unique() &&header!=null&&size==10&&header.next!=null&&header.element==0&&header.next.next!=null&&header.next.element==1&&header.next.next.next!=null&&header.next.next.element==5&&header.next.next.next.next!=null&&header.next.next.next.element==6&&header.next.next.next.next.next!=null&&header.next.next.next.next.element==7;
	}
	public static IFinitization finSLL57(int _x_) {
		IFinitization f = FinitizationFactory.create(SLL57.class);
