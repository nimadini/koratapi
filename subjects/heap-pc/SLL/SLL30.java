...
public class SLL30 {
	...
	return structureOK()&&size() &&sorted() &&unique() &&header!=null&&size==10&&header.next!=null&&header.element==0&&header.next.next!=null&&header.next.element==1&&header.next.next.next!=null&&header.next.next.element==2&&header.next.next.next.next!=null&&header.next.next.next.element==6&&header.next.next.next.next.next!=null&&header.next.next.next.next.element==8;
	}
	public static IFinitization finSLL30(int _x_) {
		IFinitization f = FinitizationFactory.create(SLL30.class);
